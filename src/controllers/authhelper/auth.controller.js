...
export const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const mail_data = dynamic_template_data({email, template_id: emailTemplates.forgotPasswordEmail, data: { first_name: name, verification_code: link } });
    sendEmail(mail_data);
...
export const resetPassword = async (req, res) => {
  ...
  try {
    ...
    const name = isAccount.first_name,
